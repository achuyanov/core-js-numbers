 ...
 * 12345, 2    => '1.23e+4'
 */
function toExponential(n, fr) {
  return n.toExponential(fr);
}
 ...
 * 12.345, 4   => '12.35'
 */
function toPrecision(n, pr) {
  return n.toPrecision(pr);
}
 ...
 * 'abcdefgh'      => NaN
 */
function getFloatOnString(st) {
  return Number.parseFloat(st);
}
 ...
 * '10', 8              => 8
 */
function getIntegerOnString(st, base) {
  return Number.parseInt(st, base);
}
